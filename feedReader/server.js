...
app.get('/deleteSubs', function(req, res) {
  var info = req.query;
...
//sending in user and link
//get user and id look in collection to see if user/id exist and user/link exist and then deete
